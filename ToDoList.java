...
class Task extends JPanel {
    ...
    Color pink = new Color(236, 100, 75);
    Color green = new Color(188, 226, 158);
    Color doneColor = new Color(240, 248, 255);
    ...
    Task() {
        ...
        taskName = new JTextField("Write the task..."); // create task name text field
...
class TitleBar extends JPanel {
    ...
    TitleBar() {
        ...
        titleText.setFont(new Font(" Playfair Display", Font.BOLD, 20)); // Font of the text
